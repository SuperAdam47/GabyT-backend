...
const langSysPrompt = "As a specialist in translation and language services, execute all instructions." // Always respond in HTML format."
...
module.exports = (cfg) => {
    ...
    function lang(prompt, doc, ref, heat) {
        ...
        return chat(langSysPrompt, messages, heat ? 1 : 0).then(format)
    }
